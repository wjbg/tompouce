...
mdata = {'name': "TC1225",
         'E1': 135E9, 'E2': 10E9, 'v12': 0.26, 'G12': 4.3,
...
L_CP1225 = Laminate([P00, P00, P00, P90, P90, P90])
...
force, _ = L_CP1225.loaddef(thermal_load)
moments = force[3:]
